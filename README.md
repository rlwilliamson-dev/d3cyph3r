...
This is **v0.7.2** — **all 7 engagement slots are now playable.** 8 levels shipped across all 7 tracks. Each level introduces one new concept and drops the player into a different client engagement with a different compliance regime in scope:
