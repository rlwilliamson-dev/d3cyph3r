...
[^adobe-2013-schneier]: [Cryptographic blunders revealed by Adobe's password leak (Schneier on Security)](https://www.schneier.com/blog/archives/2013/11/cryptographic_b.html). The 3DES-in-ECB analysis.
[^yahoo-breaches]: [Yahoo data breaches](https://en.wikipedia.org/wiki/Yahoo_data_breaches). Consolidated account of the 2013 and 2014 incidents and the 2017 upward revision to all 3 billion accounts.
