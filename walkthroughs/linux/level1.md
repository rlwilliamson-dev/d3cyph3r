...
[^cve-2020-5741]: [LastPass — Incident 2 of 2 (March 2023 follow-up disclosure; identifies the senior DevOps engineer's home computer and "vulnerable third-party software" as the entry vector — the specific identification of Plex Media Server and CVE-2020-5741 came via subsequent CISA KEV listing and security-press reporting)](https://blog.lastpass.com/posts/security-incident-update-recommended-actions).
