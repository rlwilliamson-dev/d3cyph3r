...
The CWE-798 entry has been in the catalog since the early days of CWE (entry created circa 2006) and is consistently one of the longest-standing entries in MITRE's "Top 25 Most Dangerous Software Weaknesses" rankings. It's been on every annual Top 25 list for the past decade. The weakness is well-documented, well-publicized, and continues to dominate breach post-mortems despite the prevalence of secrets-management tools that solve it.
