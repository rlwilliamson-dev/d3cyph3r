...
introduced in v1.9.0 is now seeded on all 24 shipped levels
(all 7 tracks through level2, plus level3 on linux, crypto, and forensics). Each level has at least one
