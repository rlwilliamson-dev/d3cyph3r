...
const HELP_LEARNING = {
  ...
  lines: [
    ...
    "save                     – generate a portable progress code (v1.20.0)",
    "restore <code>           – apply a progress code (prompts y/N before overwriting)",
    "restore --preview <code> – decode + summarize a code without applying it",
    "sw / sw status           – inspect service-worker state (v1.21.0)",
    "sw update                – force-check for a new D3CYPH3R version",
    "sw clear                 – unregister + wipe caches (PWA panic button)",
    "reload                   – refresh the page (applies any pending update)",
